...
function Login() {
  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      ...
      <div className="hidden md:flex md:w-1/2 items-center justify-center bg-gradient-to-r from-indigo-500 to-purple-600 animate-gradient-x">
        <div className="text-center p-12">
          <h1 className="text-4xl font-bold text-white mb-4">Your Brand</h1>
          <p className="text-xl text-indigo-100">
            Premium experience starts here
          </p>
        </div>
      </div>
    </div>
